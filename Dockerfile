...
RUN apt-get update -qq && apt-get install -y apt-utils unzip zip tree curl net-tools wget git vim procps npm supervisor \
	nginx php7.2-fpm php7.2-gd php7.2-bcmath php7.2-bz2 php7.2-cli php7.2-intl php7.2-pdo php7.2-mbstring php7.2-pgsql php7.2-iconv php7.2-soap php7.2-sockets php7.2-mysql php7.2-zip php7.2-curl php7.2-xml php-xdebug \
